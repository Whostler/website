...
2. Delete your old WordPress files, saving the ones you’ve modified.
...
WordPress is the official continuation of [b2/cafél](https://cafelog.com/), which came from Michel V. The work has been continued by the [WordPress developers](https://wordpress.org/about/). If you would like to support WordPress, please consider [donating](https://wordpress.org/donate/).
